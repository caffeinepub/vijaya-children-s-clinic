...
export default function BookAppointmentPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.childAge.trim()) newErrors.childAge = "Child age is required";
      ...
      Number.isNaN(Number(formData.childAge)) ||
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="mb-8 text-center">
        ...
        <p className="text-lg text-muted-foreground mb-4">
          Fill in the details below and we'll get back to you to confirm your
          appointment.
        </p>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-card/90 backdrop-blur border-2">
            <CardHeader>
              ...
              <CardDescription>
                Please provide your contact details and your child's
                information.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/90 backdrop-blur border-2">
            <CardHeader>
              ...
              <CardDescription>
                Select your preferred appointment date and time slot (Mon to
                Sat, 7 PM to 9 PM).
              </CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card/90 backdrop-blur border-2">
            <CardHeader>
              ...
              <CardDescription>
                Please describe the reason for your appointment (optional).
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
