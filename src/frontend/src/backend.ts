...
import type { AppointmentRequest as _AppointmentRequest, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createAppointment(arg0: AppointmentRequest): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createAppointment(to_candid_AppointmentRequest_n3(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listAppointments(): Promise<Array<AppointmentRequest>> {
        if (this.processError) {
            try {
...
function from_candid_AppointmentRequest_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AppointmentRequest): AppointmentRequest {
...
function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AppointmentRequest>): Array<AppointmentRequest> {
    return value.map((x)=>from_candid_AppointmentRequest_n9(_uploadFile, _downloadFile, x));
}
function to_candid_AppointmentRequest_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AppointmentRequest): _AppointmentRequest {
