...
export class Backend implements backendInterface {
    ...
    async createAppointment(arg0: AppointmentRequest): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createAppointment(to_candid_AppointmentRequest_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        status: to_candid_AppointmentStatus_n12(_uploadFile, _downloadFile, value.status),
