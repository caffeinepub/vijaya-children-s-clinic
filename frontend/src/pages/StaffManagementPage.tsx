...
import { Loader2, Plus, Search, Edit, Trash2, LogOut, Shield, AlertCircle } from 'lucide-react';
      ...
      <AlertDialog open={!!deletingStaff} onOpenChange={(open) => !open && setDeletingStaff(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete the staff account for <strong>{staffToDelete?.userId}</strong>?
